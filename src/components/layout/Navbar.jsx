        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            >
              ...
              <div className={`absolute left-0 mt-2 w-[800px] bg-white rounded-lg shadow-xl transition-all duration-200 z-[60] ${isServicesOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
                        ...
                        {services.map((service) => (
                          <li key={service}>
                            <Link 
                              ...
                              className="text-gray-600 hover:text-red-600 hover:bg-red-50 block px-3 py-1 rounded transition-colors duration-200"
                            >
                              {service}
                            </Link>
                          </li>
