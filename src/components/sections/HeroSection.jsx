  ...
  return (
    <div className="relative bg-secondary text-white py-32 md:py-48 z-0 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 text-white/5 animate-float" style={{ animationDelay: "2s" }}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 leading-tight font-display">
            <TypeAnimation
              sequence={[
